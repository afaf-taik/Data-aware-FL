...
import os
tries = 50 #number of times to repeat simulations
m = 6 #number of users to select
for t in range(tries):
	#directory where to save results
	dirname = 'diversity_exp/mlp_6clients_1e_fmnist/exp'+str(t)
	os.mkdir(dirname)
